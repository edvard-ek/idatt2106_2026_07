...
INSERT INTO schools (id, name, email_suffix)
VALUES (2, 'Berg Skole', '@bergskole.no');
...
INSERT INTO users (id, username, email, first_name, last_name, password)
VALUES (3, 'kari', 'kari@bergskole.no', 'Test', 'TeacherTwo', '$2y$10$exUh84ts9h5pXIm.QSqA3uHQ9M5ifNW.ePQs7lBNYDeCV7RZoY5ja');--Password123!
...
ALTER TABLE schools ALTER COLUMN id RESTART WITH 3;
ALTER TABLE classrooms ALTER COLUMN id RESTART WITH 3;
